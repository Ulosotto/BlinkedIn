            ...
            match direction:
                ...
                case "left":
                    if not self.deviceSelected:
                        ...
                        self.moveState("select")
                case "select":
                    if self.device != "Deactivate":
                        message = f"""You have selected {self.device}. To toggle this device, look right and blink.
                                    to go back to device selection, look left and blink."""
                        sendMessage("talk", message)
